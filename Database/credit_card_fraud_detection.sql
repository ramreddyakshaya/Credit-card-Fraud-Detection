...
--
-- Host: localhost
-- Generation Time: Sep 07, 2022 at 10:36 AM
...
--
CREATE DATABASE IF NOT EXISTS `credit_card_fraud_detection` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
('6uf2034uasahlr3qbae3ph3yvxsovkbj', 'eyJ1c2VyaWQiOjF9:1oVrnm:DiYEHLh2vjbqqpz7IlP67iaBQh6604b5_4t49yZqVC4', '2022-09-21 09:56:58.851026'),
...
('zqkdr6n5epuhbv7l9v7a0u3ee352fyc9', 'eyJ1c2VyaWQiOjJ9:1oVsK2:6uVMxwxVf0xldT9k7gGFxEB32dIEOYkd0JWglkGS8nY', '2022-09-21 10:30:18.692590');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_cc_fraud_detection_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_cc_fraud_detection_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `trans_date` varchar(300) NOT NULL,
  `cc_num` varchar(300) NOT NULL,
  `category` varchar(300) NOT NULL,
  `AMT_TRANS` varchar(300) NOT NULL,
  ...
  `User_Lat` varchar(300) NOT NULL,
  `User_Long` varchar(300) NOT NULL,
  `city_pop` varchar(300) NOT NULL,
  `Job` varchar(300) NOT NULL,
  `Dob` varchar(300) NOT NULL,
  `trans_num` varchar(300) NOT NULL,
  `merch_lat` varchar(300) NOT NULL,
  `merch_long` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_cc_fraud_detection_type`
--

INSERT INTO `remote_user_cc_fraud_detection_type` (`id`, `trans_date`, `cc_num`, `category`, `AMT_TRANS`, `first`, `last`, `gender`, `street`, `city`, `state`, `zip`, `User_Lat`, `User_Long`, `city_pop`, `Job`, `Dob`, `trans_num`, `merch_lat`, `merch_long`, `Prediction`) VALUES
(1, '21-06-20 12:19', '4910000000000000', 'kids_pets', '270000', 'Lauren', 'Torres', 'F', '03030 White Lakes', 'Grandview', 'TX', '76050', '32.2779', '-97.2351', '5875', 'Radiographer, therapeutic', '24-07-92', '67288141e8206f6f49706c1cef5b75d3', '33.182349', '-97.919284', 'No Credit Card Fraud'),
(2, '21-06-20 12:21', '213000000000000', 'travel', '239850', 'Rebecca', 'Conley', 'F', '181 Moreno Light Apt. 215', 'Tomahawk', 'WI', '54487', '45.4963', '-89.7273', '9594', 'Seismic interpreter', '23-11-97', '79f931ffc97dfe9966cd7d09613fe308', '45.47444', '-89.539774', 'Credit Card Fraud'),
(3, '21-06-20 12:23', '6010000000000000', 'health_fitness', '979992', 'William', 'Johnson', 'M', '50843 Vincent Mission', 'South Londonderry', 'VT', '5155', '43.1699', '-72.8515', '828', 'Scientific laboratory technician', '30-08-57', '6c58a441ceeb7dc623316c6a68158d29', '42.390565', '-71.932418', 'No Credit Card Fraud'),
(4, '21-06-20 13:21', '3590000000000000', 'health_fitness', '364896', 'Crystal', 'Fuller', 'F', '000 Jennifer Mills', 'Issaquah', 'WA', '98027', '47.4974', '-122.0107', '50489', 'Osteopath', '29-02-84', '9ff38367441a692eeae413805a128ea5', '47.008606', '-122.947605', 'No Credit Card Fraud');
...
(1, 'Karthik', 'Karthik123@gmail.com', 'Karthik', '9535866270', 'India', 'Karnataka', 'Bangalore', '#7822,11th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,4th Cross,Viajyanagar', 'Male');
...
(32, 'Naive Bayes', '65.85639072476755'),
(33, 'SVM', '67.8279377170382'),
(34, 'Logistic Regression', '67.8279377170382'),
(35, 'Decision Tree Classifier', '67.8279377170382'),
(36, 'Gradient Boosting Classifier', '67.8335387028117');
...
(14, 'No Credit Card Fraud', '75.0'),
(15, 'Credit Card Fraud', '25.0');
